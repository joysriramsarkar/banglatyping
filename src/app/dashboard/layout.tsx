...
import UserModeSelector from "@/components/common/UserModeSelector";
  ...
  if (!user) {
    return (
      <div className="p-2 group-data-[collapsible=expanded]:space-y-2">
        <p className="text-sm text-center text-muted-foreground group-data-[collapsible=icon]:hidden">
...
function DashboardLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const isPracticePage = pathname.includes("/dashboard/practice") && pathname !== "/dashboard/practice/mistakes";
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      <SidebarProvider>
        ...
        <SidebarInset className={cn(isPracticePage && "w-full max-w-full")}>
          <header className={cn("sticky top-0 z-10 flex h-14 items-center justify-between gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6", isPracticePage && "hidden")}>
          ...
          <main className={cn("p-4 sm:p-6", isPracticePage && "p-4 sm:p-6 md:p-8 max-w-7xl mx-auto w-full flex justify-center")}>
