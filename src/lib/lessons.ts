...
const generateWordPracticeText = (words: string[]): string => {
    let text = '';
    // Repeat the words to create a long text, suitable for a 6-minute drill.
    for (let i = 0; i < 20; i++) {
        text += words.join(' ') + ' ';
    }
    return text.trim();
...
export const lessons: Lesson[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    level: "Beginner",
    row: "home-row",
    text: generateWordPracticeText(homeRowWords)
  },
  {
  ...
  },
  {
    ...
    level: "Beginner",
    row: "top-row",
    text: generateWordPracticeText(topRowWords)
  },
  {
  ...
  },
  {
  ...
  },
   {
    ...
    level: "Beginner",
    row: "bottom-row",
    text: generateWordPracticeText(bottomRowWords)
  },
  {
