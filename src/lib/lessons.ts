...
const getStepsForChar = (char: string): SingleDrill[] => {
    ...
    const vowelEntry = Object.entries(vowelSigns).find(([_, vowel]) => vowel === char);
    ...
    if (char.length > 1 && char.includes('্')) {
        ...
        const lastCharOfSecond = secondChar.slice(-1);
        if (vowelSigns[lastCharOfSecond as keyof typeof vowelSigns]) {
            kar = lastCharOfSecond;
            lastChar = secondChar.slice(0, -1);
        } else {
            lastChar = secondChar;
        }
    ...
    const lastCharOfInput = char.slice(-1);
    const kar = vowelSigns[lastCharOfInput as keyof typeof vowelSigns] ? lastCharOfInput : null;
    if (kar) {
...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    level: "Intermediate",
    text: "রাম বনে ফুল পাড়ে। গায়ে তার লাল শাল। হাতে তার সাজি। জবা ফুল তোলে। বেল ফুল তোলে। বেল ফুল সাদা। জবা ফুল লাল। জলে আছে নাল ফুল। ফুল তুলে রাম বাড়ি चले। তার বাড়ি আজ পূজা। পূজা হবে রাতে। তাই রাম ফুল আনে। তাই তার ঘরে খুব ঘটা। ঢাক বাজে, ঢোল বাজে। ঘরে ঘরে ধূপ ধূনা।",
  },
  {
    id: "sahaj-path-3",
...
export const practiceParagraphs: string[] = [
  ...
  "ঐ সাদা ছাতা। দাদা যায় হাটে। গায়ে লাল জামা। মামা যায় খাতা হাতে। গায়ে শাদা শাল। মামা আনে চাল ডال। আর কেনে শাক। আর কেনে আটা। দাদা কেনে পাকা আটা, সাত আনা দিয়ে। আর, আখ আর জাম চার আনা। বাবা খাবে। কাকা খাবে। আর খাবে মামা। তার পরে কাজ আছে। বাবা কাজে যাবে। এই সাধারণ দৃশ্যগুলো আমাদের জীবনের অংশ।",
  ...
  "আমাদের ছোটো নদী চলে বাঁকে বাঁke, বৈশাখ মাসে তার হাঁটুজল থাকে। পার হয়ে যায় গোরু, পার হয় গাড়ি, দুই ধার উঁচু তার, ঢালু তার পাড়ি। চিকচিক করে বালি, কোথা নাই কাদা, এক ধারে কাশবন ফুলে ফুলে শada। কিচিমিচি করে সেথা শালিকের ঝাঁক, রাতে ওঠে থেকে থেকে শেয়ালের হাঁক। আর-পারে আমবন তালবন চলে, গাঁয়ের বামুনপাড়া তারি ছায়াতলে। তীরে তীরে ছেলেমেয়ে নাহিবার কালে গامছায় জল ভরি গায়ে তারা ঢালে। সকালে বিকালে কভু নাওয়া হলে পরে আঁচলে ছাঁকিয়া তারা ছোটো মাছ ধরে। বালি দিয়ে মাজে থালা, ঘটিগুলি মাজে, বধূরা কাপড় কেচে যায় গৃহকাজে। আষাঢ়ে বাদল নামে, নদী ভর-ভর- মাতিয়া ছুটিয়া চলে ধারা খরতর। মহাবেগে কলকল কোলাহল ওঠে, ঘোলাজলে পাকগুলি ঘুরে ঘুরে ছোটে। দুই কূলে বনে বনে পড়ে যায় সাড়া, বরষার উৎসবে জেগে ওঠে পাড়া।",
  "এসেছে শরৎ, হিমের পরশ লেগেছে হাওয়ার 'পরে- সকালবেলায় ঘাসের আগায় শিশিরের রেখা ধরে। আমলকী-বন কাঁপে, যেন তার বুক করে দুরু দুরু পেয়েছে খবর পাতা-খসানোর সময় হয়েছে শুরু। শিউলির ডাale কুঁড়ি ভরে এল, টগর ফুটিল মেলা, মালতীলতায় খোঁজ নিয়ে যায় মৌমাছি দুই বেলা। গগনে গগনে বরষণ-শেষে মেঘেরা পেয়েছে ছাড়া, বাতাসে বাতাসে ফেরে ভেসে ভেসে, নাই কোনো কাজে তাড়া। দীঘিভرا জল করে ঢলঢল, নানা ফুল ধারে ধারে, কচি ধানগাছে ক্ষেত ভরে আছে- হাওয়া দোলা দেয় তারে। যে দিকে তাকাই সোনার আলোয় দেখি যে ছুটির ছবি, পূজার ফুলের বনে ওঠে ওই পূজার দিনের রবি।",
