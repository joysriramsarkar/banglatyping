...
const generateDrills = (chars: string[], count: number): Drill[] => {
    ...
    for (let i = 0; i < count; i++) {
        ...
        if (mapping) {
            ...
            // Special handling for juktabarna like ক্ষ (k+hasant+ssa)
            if (char === 'ক্ষ') {
                steps.splice(0, 1, 
                    { key: 'k', shift: false },
                    { key: 'h', shift: false },
...
const vowelSigns: { sign: string, key: string, shift: boolean }[] = [
    { sign: 'া', key: 'a', shift: false }, { sign: 'ি', key: 'i', shift: false }, { sign: 'ী', key: 'i', shift: true },
    { sign: 'ু', key: 'u', shift: false }, { sign: 'ূ', key: 'u', shift: true }, { sign: 'ৃ', key: ',', shift: false },
    { sign: 'ে', key: 'e', shift: false }, { sign: 'ৈ', key: 'e', shift: true }, { sign: 'ো', key: 'o', shift: false },
    { sign: 'ৌ', key: 'o', shift: true }, { sign: '্য', key: 'z', shift: false }
];
...
const generateKarDrillsForConsonant = (consonant: string): Drill[] => {
    ...
    for (const sign of shuffledVowelSigns) {
        const combinedPrompt = consonant + sign.sign;
        const steps: SingleDrill[] = [];

        steps.push({ key: conMapping.key, shift: conMapping.bnShift === consonant });

        if (sign.sign !== 'া' && sign.sign !== '্য') {
            steps.push({ key: hasantKey.key, shift: false });
        }
        
        steps.push({ key: sign.key, shift: sign.shift });
...
export const lessons: Lesson[] = [
  ...
  ...consonants.map(consonant => ({
    ...
    drills: generateKarDrillsForConsonant(consonant.bn),
  })),
  ...
  },
  {
    ...
    level: "Beginner",
    text: "ক কা কি কী কু কূ কৃ কে কৈ কো কৌ ক্য। খ খা খি খী খু খূ খৃ খে খৈ খো খৌ খ্য। গ গা গি গী গু গূ গৃ গে গৈ গো গৌ গ্য। ঘ ঘা ঘি ঘী ঘু ঘূ ঘৃ ঘে ঘৈ ঘো ঘৌ ঘ্য। চ চা চি চী চু চূ বৃ চে চৈ চো চৌ চ্য। জ জা জি জী জু জূ জৃ জে জৈ জো জৌ জ্য। ট টা টি টী টু টূ টৃ টে টৈ টো টৌ ট্য। দ দা দি দী দু দূ দৃ দে দৈ দো দৌ দ্য। ন না নি নী নু নূ নৃ নে নৈ নো নৌ ন্য। প পা পি পী পু পূ পৃ পে পৈ পো পৌ প্য। ব বা বি বী বু বূ বৃ বে বৈ বো বৌ ব্য। ম মা মি মী মু মূ মৃ মে মৈ মো মৌ ম্য। র রা রি রী রু রূ রৃ রে রাই রো রৌ র্য। ল লা লি লী লু লূ বৃ লে লৈ লো লৌ ল্য। স সা সি সী সু সূ সৃ সে সৈ সো সৌ স্য।",
  },
  {
    id: "sahaj-path-1",
...
export const practiceParagraphs: string[] = [
  ...
  "মুক্তিযুদ্ধ ছিল ১৯৭১ সালে অনুষ্ঠিত একটি ঐতিহাসিক যুদ্ধ। এই যুদ্ধের মাধ্যমে বাংলাদেশ পাকিস্তান থেকে স্বাধীনতা লাভ করে। নয় মাস ধরে চলা এই রক্তক্ষয়ী সংগ্রামে প্রায় ৩০ লক্ষ মানুষ শহীদ হন এবং বহু নারী ধর্ষণের শিকার হন। বাংলাদেশের স্বাধীনতা লাভে ভারতের অবদান অনস্বীকার্য। এই বিজয় আমাদের অহংকার। এই সংগ্রামের মাধ্যমে আমরা পেয়েছি একটি স্বাধীন দেশ, একটি নতুন পতাকা এবং একটি নতুন পরিচয়। এই স্বাধীনতা রক্ষার দায়িত্ব আমাদের সকলের।",
  ...
  "বনে থাকে বাঘ। গাছে থাকে পাখি। জলে থাকে মাছ। ডালে আছে ফল। পাখি ফল খায়। পাখা মেলে ওড়ে। বাঘ আছে আম-বনে। গায়ে চাকা চাকা দাগ। পাখি বনে গান গায়। মাছ জলে খেলা করে। ডালে ডাale কাক ডাকে। খালে বক মাছ ধরে। বনে কত মাছি ওড়ে। ওরা সব মৌ-মাছি। ঐখানে মৌ-চাক। তাতে আছে মধু ভরা। এই প্রাকৃতিক দৃশ্য মনকে শান্ত করে।",
