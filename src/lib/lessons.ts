...
export const lessons: Lesson[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    level: "Beginner",
    row: "home-row",
    drills: generateWordDrills(homeRowWords),
    isWordDrill: true,
  },
  ...
  },
  {
    ...
    level: "Beginner",
    row: "top-row",
    drills: generateWordDrills(topRowWords),
    isWordDrill: true,
  },
  ...
  },
  {
  ...
  },
   {
    ...
    level: "Beginner",
    row: "bottom-row",
    drills: generateWordDrills(bottomRowWords),
    isWordDrill: true,
  },
...
export const practiceParagraphs: string[] = [
  ...
  "এসেছে শরৎ, হিমের পরש লেগেছে হাওয়ার 'পরে- সকালবেলায় ঘাসের আগায় শিশিরের রেখা ধরে। আমলকী-বন কাঁপে, যেন তার বুক করে দুরু দুরু পেয়েছে খবর পাতা-খসানোর সময় হয়েছে শুরু। শিউলির ডাale কুঁড়ি ভরে এল, টগর ফুটিল মেলা, মালতীলতায় খোঁজ নিয়ে যায় মৌমাছি দুই বেলা। গগনে গগনে বরষণ-শেষে মেঘেরা পেয়েছে ছাড়া, বাতাসে বাতাসে ফেরে ভেসে ভেসে, নাই কোনো কাজে তাড়া। দীঘিভra জল করে ঢলঢল, নানা ফুল ধারে ধারে, কচি ধানগাছে ক্ষেত ভরে আছে- হাওয়া দোলা দেয় তারে। যে দিকে তাকাই সোনার আলোয় দেখি যে ছুটির ছবি, পূজার ফুলের বনে ওঠে ওই পূজার দিনের রবি।",
